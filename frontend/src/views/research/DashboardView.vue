...
<template>
  <div class="dashboard-page slim-scroll">
    ...
    <div class="welcome-section">
      <div class="greeting">
        <h1>{{ user.name || user.username }}，下午好</h1>
        <p>你的 AI 研读工作台已就绪</p>
      </div>
    ...
    <div class="stats-row">
      ...
      <div class="stat-card" @click="quickActions('new-session')">
    ...
    <div class="quick-actions">
      ...
      <button class="qa-card" @click="quickActions('library')">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
        <span>管理文献库</span>
      </button>
